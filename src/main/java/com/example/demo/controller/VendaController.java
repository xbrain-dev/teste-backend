...
public class VendaController {
   ...
   */
  @GetMapping("/ranking")
  public Stream<VendedorDTO> rankingDezMelhores(@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate dataStart,
                                                @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate dataEnd,
                                                @RequestParam Long maxRanking) throws DatasInvalidasException {
    if (dataStart.isAfter(dataEnd)) {
      throw new DatasInvalidasException("As datas não são válidas.");
    }
