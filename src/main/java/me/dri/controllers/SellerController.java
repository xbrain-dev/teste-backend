...
import me.dri.entities.dto.BestSellersDTO;
...
public class SellerController {
    ...
    @GetMapping
    ResponseEntity<List<BestSellersDTO>> bestSellersOfWeekend() {
        return ResponseEntity.ok().body(this.service.bestSellersWeekend());
    }
